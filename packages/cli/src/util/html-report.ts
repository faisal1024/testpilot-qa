import { type AnalysisReport, type Finding, type ScoreBreakdown, VERSION } from '@testpilot/core'
...
export function toHtml(report: AnalysisReport): string {
  ...
  return [
    ...
    `<footer>Generated by TestPilot QA v${esc(VERSION)} — static Tier 1 analysis. Findings are heuristic; they are not DOM-verified facts.</footer>`,
    '</main>',
    '</body>',
    '</html>',
    '',
